...
import { MDBTable, MDBRow, MDBCol, MDBBtn, MDBBadge, MDBIcon } from "mdb-vue-ui-kit";
    ...
    <MDBRow start class="justify-content-center">
      <MDBCol col="10">
        <div class="mt-4 d-flex justify-content-between">
          <h2 style="font-weight: 600;">Gastos</h2>
        ...
        <MDBTable class=" table-border align-middle mb-0 bg-white mt-4">
          ...
          <tbody>
            <tr v-for="(gasto, index) in gastos" :key="index">
              ...
              <td>
                <div class="d-flex">
                  <MDBBtn color="link" size="sm" floating @click="edit(gasto.idGasto)">
                    <MDBIcon icon="pen"></MDBIcon>
                  </MDBBtn>
                  <MDBBtn color="link" size="sm" floating @click="remove(gasto.idGasto)">
